<?php echo form_open('admin/create_post'); ?>
...
<div class="jumbotron bg-light col-12 offset-0 col-lg-6 offset-lg-3 mt-3 pt-4">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				<button type="submit" name="action" value="update" class="btn btn-secondary btn-lg mt-4 ">Létrehozás!</button>
			</div>
		</div>
	</div>	
</div>
